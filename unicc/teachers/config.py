...
CONFIG = {
            ...
            "nove": {
                ...
                "mean": torch.tensor([588.4096, 614.0557, 438.3721, 942.7473, 1769.8485, 2049.4758, 2193.2920, 1568.2118, 997.7151]).view(1, 9, 1, 1),
                "std": torch.tensor([684.5688, 603.2968, 607.0269, 727.5784, 1087.4288, 1261.4303, 1369.3717, 1063.9198, 806.8846]).view(1, 9, 1, 1),
            },
            }
